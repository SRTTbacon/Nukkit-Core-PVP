package srttbacon.plugin.Class.ScoreBoard.map;
...
public class Long2ObjectArrayMap<V> extends AbstractLong2ObjectMap<V> implements Cloneable {
	...
	public Long2ObjectArrayMap<V> clone() {
        ...
        return (Long2ObjectArrayMap<V>) c;
    }
        ...
        public class EntrySet extends AbstractObjectSet<Entry<V>> implements FastEntrySet<V> {
                ...
                return new ObjectIterator<Entry<V>>() {
					...
					public Entry<V> next() {
                        if ( !this.hasNext() ) {
                            ...
                            return (Entry<V>) new BasicEntry<Object>( Long2ObjectArrayMap.this.key[this.curr = this.next], Long2ObjectArrayMap.this.value[this.next++] );
                        }
                    }
            ...
            public ObjectIterator<Entry<V>> fastIterator() {
                return new ObjectIterator<Entry<V>>() {
                    ...
                    int curr = -1;
                    @SuppressWarnings("unchecked")
					BasicEntry<V> entry = (Long2ObjectArrayMap<V>.BasicEntry<V>) new BasicEntry<Object>();
